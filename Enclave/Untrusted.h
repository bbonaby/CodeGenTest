...
namespace CodeGenTest
{
    namespace Untrusted::Stubs
    {
        ...
        {
            FlatbuffersDevTypes::TestFunc_1_argsT in_flatbufferT {};
            ...
            THROW_IF_FAILED((VbsEnclaveABI::Enclave::CallVtl0CallbackFromVtl1<ParamsT, ReturnParamsT>("CodeGenTest::AbiDefinitions::TestFunc_1_Generated_Stub", flatbuffer_builder, function_result)));
            
            auto return_params = VbsEnclaveABI::Shared::Converters::ConvertStruct<TestFunc_1_args>(function_result);
