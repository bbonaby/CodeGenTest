...
namespace CodeGenTest::Trusted::Stubs
{
    ...
    struct CodeGenTestClass
    {
        ...
        {
            FlatbuffersDevTypes::TestFunc_0_argsT in_flatbufferT {};
            ...
            THROW_IF_FAILED((VbsEnclaveABI::HostApp::CallVtl1ExportFromVtl0<ReturnParamsT>(m_enclave, "TestFunc_0_Generated_Stub", flatbuffer_builder, function_result)));
            
            auto return_params = VbsEnclaveABI::Shared::Converters::ConvertStruct<TestFunc_0_args>(function_result);
        ...
        private:
            ...
            std::array<uintptr_t, 3> m_callback_addresses{ reinterpret_cast<uintptr_t>(&VbsEnclaveABI::HostApp::AllocateVtl0MemoryCallback),reinterpret_cast<uintptr_t>(&VbsEnclaveABI::HostApp::DeallocateVtl0MemoryCallback), reinterpret_cast<uintptr_t>(&AbiDefinitions::TestFunc_1_Generated_Stub) };
            std::array<std::string, 3> m_callback_names{ "VbsEnclaveABI::HostApp::AllocateVtl0MemoryCallback","VbsEnclaveABI::HostApp::DeallocateVtl0MemoryCallback", "CodeGenTest::AbiDefinitions::TestFunc_1_Generated_Stub" };
    };
}
