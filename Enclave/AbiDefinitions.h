...
namespace CodeGenTest
{
    namespace AbiDefinitions
    {
        ...
        static inline void TestFunc_0_Abi_Impl(_In_ FlatbuffersDevTypes::TestFunc_0_argsT& in_flatbuffer_params, _In_ flatbuffers::FlatBufferBuilder& flatbuffer_out_params_builder)
        {
            auto dev_type_params = VbsEnclaveABI::Shared::Converters::ConvertStruct<TestFunc_0_args>(in_flatbuffer_params);
            dev_type_params.m__return_value_ = Trusted::Implementation::TestFunc( dev_type_params.m_arg1, dev_type_params.m_arg2.get(), dev_type_params.m_arg3.get(), dev_type_params.m_arg4, dev_type_params.m_arg5, dev_type_params.m_arg6, dev_type_params.m_arg7, dev_type_params.m_arg8, dev_type_params.m_arg9);
        ...
        static inline void* TestFunc_0_Generated_Stub(void* function_context)
        try
        {
            using ParamsT = FlatbuffersDevTypes::TestFunc_0_argsT;
            using ReturnParamsT = FlatbuffersDevTypes::TestFunc_0_argsT;
            EnforceMemoryRestriction();
            HRESULT hr = VbsEnclaveABI::Enclave::CallVtl1ExportFromVtl1<ParamsT, decltype(AbiDefinitions::TestFunc_0_Abi_Impl)>(function_context, AbiDefinitions::TestFunc_0_Abi_Impl);
            LOG_IF_FAILED(hr);
